...
void honk(unsigned long duration) {
  digitalWrite(HORN_PIN, HIGH);   // turn the LED on (HIGH is the voltage level)
  delay(duration);                       // wait for a second
  digitalWrite(HORN_PIN, LOW);    // turn the LED off by making the voltage LOW
